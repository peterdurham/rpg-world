...
const Preview = ({
  ...
  let scoreDisplay =
    score >= 8.5 ? (
      <div className="Preview__score Preview__score--green">{score}</div>
    ) : (
      <div className="Preview__score Preview__score--yellow">{score}</div>
    );
  ...
  return (
    <div className="Preview" onClick={() => viewDetails(title)}>
      ...
      <div className="Preview__content">
        ...
        <div className="Preview__developer">
          <span className="Preview__bold">Developer:</span> {developer},{" "}
          {release}
        </div>
        <div className="Preview__platforms">
          <span className="Preview__bold">Platforms:</span>{" "}
          {platforms.map(platform => ` ${platform}`)}
        </div>
        <div className="Preview__genre">
          <span className="Preview__bold">Genre:</span> {genre}
        </div>
      </div>
      {scoreDisplay}
    </div>
