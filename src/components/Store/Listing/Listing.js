...
const Listing = (props) => {
    ...
    return (
        <div className="Listing" onClick={()=>props.viewDetails(props.title)}>
            <img src={img} alt="cover" className="Listing__img"/>
            <div className="Listing__content">
                <div className="Listing__title">{props.title}</div>
                <div className="Listing__platforms">{props.platforms}</div>
                <div className="Listing__genre">{props.genre}</div>
            </div>
            <div className="Listing__price">{props.price}</div>
        </div>
    );
}
