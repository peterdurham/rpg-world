...
class Carousel extends Component {
    ...
    let slide1 = (this.state.carouselSlide===1) ?
        <div className="Carousel__slide" onClick={()=>this.props.viewDetails("Baldur's Gate")}>
            ...
            <div className="Carousel__contents">
                ...
                <div className="Carousel__screenshots">
                    <img src={BaldursGateScreen1} alt="screenshot" className="Carousel__screenshot"/>
                    <img src={BaldursGateScreen2} alt="screenshot" className="Carousel__screenshot" />
                </div>
    ...
    let slide2 = (this.state.carouselSlide===2) ?
        <div className="Carousel__slide" onClick={()=>this.props.viewDetails("BloodBorne")}>
                    ...
                    <div className="Carousel__contents">
                        ...
                        <div className="Carousel__screenshots">
                            <img src={BloodborneScreen1} alt="screenshot" className="Carousel__screenshot"/>
                            <img src={BloodborneScreen2} alt="screenshot" className="Carousel__screenshot" />
                        </div>
                        <div className="Carousel__text">Now Available</div>
    ...
    <div className="Carousel__slide" onClick={()=>this.props.viewDetails("Chrono Trigger")}>
            <img src={ChronoTrigger} alt="bg" className="Carousel__img"/>
            <div className="Carousel__contents">
                <div className="Carousel__name">Chrono Trigger</div>
                <div className="Carousel__screenshots">
                    <img src={ChronoTriggerScreen1} alt="screenshot" className="Carousel__screenshot"/>
                    <img src={ChronoTriggerScreen2} alt="screenshot" className="Carousel__screenshot" />
                </div>
                <div className="Carousel__text">Now Available</div>
        ...
        <div className="Carousel__slide" onClick={()=>this.props.viewDetails("Pillars of Eternity")}>
            <img src={PillarsofEternity} alt="bg" className="Carousel__img"/>
            <div className="Carousel__contents">
                <div className="Carousel__name">Pillars of Eternity</div>
                <div className="Carousel__screenshots">
                    <img src={PillarsofEternityScreen1} alt="screenshot" className="Carousel__screenshot"/>
                    <img src={PillarsofEternityScreen2} alt="screenshot" className="Carousel__screenshot" />
                </div>
                <div className="Carousel__text">Now Available</div>
        ...
        <div className="Carousel__slide" onClick={()=>this.props.viewDetails("Xenoblade Chronicles")}>
            <img src={XenobladeChronicles} alt="bg" className="Carousel__img"/>
            <div className="Carousel__contents">
                <div className="Carousel__name">Xenoblade Chronicles</div>
                <div className="Carousel__screenshots">
                    <img src={XenobladeChroniclesScreen1} alt="screenshot" className="Carousel__screenshot"/>
                    <img src={XenobladeChroniclesScreen2} alt="screenshot" className="Carousel__screenshot" />
                </div>
                <div className="Carousel__text">Now Available</div>
                <div className="Carousel__genre">Action RPG</div>
                <div className="Carousel__bottomline">
        ...
        return(
            <div className="Carousel">
                <div className="Carousel__display">
                    <div className="Carousel__slider--left" onClick={this.slideCarouselLeft}><i className="fa fa-arrow-left"></i></div>
                    {slide1}{slide2}{slide3}{slide4}{slide5}
                    <div className="Carousel__slider--right" onClick={this.slideCarouselRight}><i className="fa fa-arrow-right"></i></div>
                </div>
                <div className="Carousel__nav">
                    <div className={this.state.carouselSlide===1 ? "Carousel__box Carousel__selected": "Carousel__box"}></div>
                    <div className={this.state.carouselSlide===2 ? "Carousel__box Carousel__selected": "Carousel__box"}></div>
                    <div className={this.state.carouselSlide===3 ? "Carousel__box Carousel__selected": "Carousel__box"}></div>
                    <div className={this.state.carouselSlide===4 ? "Carousel__box Carousel__selected": "Carousel__box"}></div>
                    <div className={this.state.carouselSlide===5 ? "Carousel__box Carousel__selected": "Carousel__box"}></div>
                </div>
            </div>
        ); 
    }
